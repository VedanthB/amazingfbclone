...
const SignUp = () => {
  return (
    <div className="signup__wrapper w-screen h-screen flex items-center justify-center bg-light-primary">
      <div className="signup__container bg-white h-3/5 w-2/5 px-10 py-10 rounded-3xl">
        <span className="signup__title text-4xl">Sign Up</span>
        <div className="signup__inputs flex flex-col mt-8">
          <div className="signup__input-wrapper">
            <label htmlFor="email" className="block text-xl">
              Name
            </label>
            <input
              className="signup__input outline-none px-4 py-2 w-3/5 border-2 border-light-secondary focus-within:border-light-primary rounded"
              type="email"
              name="email"
